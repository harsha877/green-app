...
import { CUSTOM_QUESTION_HEAD_TAG, CUSTOM_QUESTION_NEXT_TAG, CUSTOM_QUESTION_SUBMIT_TAG, QUIZ_TEMPLATE } from '../constant/constants';
import { Picker } from "@react-native-picker/picker";

import CustumeButton from "../components/button";

export default function QuizInput({ navigation}) {
